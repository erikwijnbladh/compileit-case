...
import type { AvailabilityResponse, AvailabilitySlot } from "@/lib/rooms";
...
export function WeekView({
  ...
  function toggleRoom(roomId: number) {
    ...
    if (selected && !base.has(selected.room.id)) {
      setSelected(null);
    }
  }
